...
//Crear Mensajes
contactoRutas.post('/newContact', (req, res) => {
    const body = req.body;
...
//Borrar Mensajes
contactoRutas.delete('/deletedContact/:id', (req, res) => {
...
//Obtener Mensaje
contactoRutas.get('/getSms', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
