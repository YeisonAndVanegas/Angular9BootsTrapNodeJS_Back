...
//Actualizar sobre Mi
sobreMiRutas.post('/updateSobreMi/:id', autentificacion_1.verificarToken, (req, res) => {
...
//Obtener SobreMi
sobreMiRutas.get('/getSobreMi', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
