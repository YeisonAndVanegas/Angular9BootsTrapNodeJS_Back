...
//Subir Imagenes
yoRutas.post('/uploadImg', autentificacion_1.verificarToken, (req, res) => {
    const body = req.body;
...
yoRutas.get('/Yeison/:img', (req, res) => {
...
yoRutas.delete('/:id/:name', autentificacion_1.verificarToken, (req, res) => {
    ...
    imagenesYo_1.ImagenesYo.findByIdAndRemove(id, (err, imgBorrar) => {
        ...
        fs_1.default.unlinkSync(path_1.default.resolve(__dirname, '../uploads', 'Yeison', name));
    });
});
